...
import jp.ambrosoli.http.client.ahc.headers.AHCHeaderBuilder;
import jp.ambrosoli.http.client.ahc.params.AHCEnclosingParamBuilder;
import jp.ambrosoli.http.client.ahc.response.AHCResponseHandler;
import jp.ambrosoli.http.client.enums.AuthType;
import jp.ambrosoli.http.client.enums.HttpMethod;
import jp.ambrosoli.http.client.exception.IORuntimeException;
import jp.ambrosoli.http.client.exception.SocketTimeoutRuntimeException;
import jp.ambrosoli.http.client.headers.HttpHeaders;
import jp.ambrosoli.http.client.params.AuthInfo;
import jp.ambrosoli.http.client.params.BasicQueryStringBuilder;
