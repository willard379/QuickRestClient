...
import jp.ambrosoli.http.client.ahc.util.AHCUtil;
import jp.ambrosoli.http.client.headers.HttpHeader;
import jp.ambrosoli.http.client.response.AbstractHttpResponse;
import jp.ambrosoli.http.client.response.ByteArrayResponseContent;
